...
const processMessage = (msg, ch) => {
    try {
        if (msg) {
            ...
            console.log(`[Delivery Service] Procesando envío ${delivery.delivery_id} - Cliente: ${delivery.customer} - Estado: ${delivery.status} (${delivery.estimated_time_minutes} min)`);
            ch.ack(msg);
        }
    } catch (error) {
...
const startService = async () => {
    ...
    const setupConsumer = async () => {
        try {
            ...
            console.log("[Delivery Service] Esperando órdenes de envío...");
